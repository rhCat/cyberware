...
*Snapshot: 2026-06-13.* Tracking pass (`DRY_RUN`): the plan classified, nothing fired. Progress is redeemed, not asserted — see §7.

## 1. Roll-up

**Status: ok** (tracking pass)

**Playbook:** 14 of 90 steps redeemed — `███░░░░░░░░░░░░░░░░░` 16%

**Program:** 14 of 90 DAG tasks redeemed — `███░░░░░░░░░░░░░░░░░` 16%

`14 redeemed · 14 blocked:deps · 52 blocked:validator · 10 dry`

Done-ledger: 14 pass entries (chain not re-verified here — see §7).

## 2. Milestones

| milestone | rung | closure | gate | status |
|---|---|---|---|---|
| **M0** — The spine stands — governed execution end to end (internal) | - | 3/15 | `P6-T05` | open |
| **M1** — SV-1 — the protocol is real and portable | SV-1 | 7/7 | `P0-T18` | **closed** |
| **M2** — SV-2 — evidence becomes tamper-evident | SV-2 | 2/8 | `P1-T09, P1-T10` | open |
...
| **M6** — SV-6 — the work pays for the work  (the ladder closes) | SV-6 | 3/21 | `P6-T21` | open |
...
| `P1-T01` | `cws-ledgercheck` | Ledger v2: append-only JSONL + prev-chain + genesis binding |
...
|---|---|---|
| `P1-T02` | `cws-ledgercheck` | `P1-T01` |
| `P1-T03` | `cws-ledgercheck` | `P1-T01` |
| `P1-T04` | `cws-ledgercheck` | `P1-T01` |
| `P1-T07` | `cws-ledgercheck` | `P1-T01` |
...
- **14 steps blocked on dependencies** — upstream tasks must redeem first (§4).
