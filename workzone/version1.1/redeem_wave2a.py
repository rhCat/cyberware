#!/usr/bin/env python3
"""redeem_wave2a.py — drive P3-T16 + P5-T05 validators through a FRESH govd, redeem both onto done-ledger-v2.
...
PORT = 5796; BASE = f"http://127.0.0.1:{PORT}"
RUNS = os.path.join(ROOT, "workzone/version1.1/runs")
GROOT = os.path.join(RUNS, "wave2a-govd-root")
SW = os.path.join(ROOT, "workzone/version1.1/cyberware-swarm-v1.1")
DL = os.path.join(SW, "done-ledger-v2.json")
JOBS = [("P3-T16", "cws-release", "security-doorbell"), ("P5-T05", "cws-bench", "trace-propagation")]
