...
- **per-perk contract** — every one of the 166 perks (across 43 skills) compiles to a clean, consistent,
...
| override | `PLAYWRIGHT_BROWSERS_PATH=<dir>` (set it for a pinned/offline install) |
...
- [skills](docs/skills.md) — the catalog (43 skills)
